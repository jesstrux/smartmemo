<?php
    ...
    $sql = "SELECT u.id, u.activation, u.status, CONCAT(u.fname, ' ', u.mname, ' ', u.surname) AS name, u.email, u.phoneNumber AS phone, IF(u.activation != 0, 'true', 'false') AS activated, d.name AS department, j.name AS job, r.id AS role_id, r.name AS role";
    $sql .= " FROM users u";
