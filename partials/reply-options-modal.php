<div id="replyOptions" class="modal alert">
    <div class="modal-content">
        <button class="closer" onclick="closeModal('replyOptions');">
            <i class="zmdi zmdi-close"></i>
        </button>

        <div class="modal-title">Pick An Option</div>
        <div class="modal-body">
            <div class="option-item" onclick="closeModal('replyOptions'); sendReply(1)">
            ...
            <div class="option-item" onclick="closeModal('replyOptions'); sendReply(2)">
